...
<body>
        ...
        <div class="controls">
            ...
            <div>
                ...
                <select id="leagueSelect">
                    ...
                    <option value="bra.copa_do_brasil">🇧🇷 Copa do Brasil</option>
    ...
    <script>
        const LEAGUES = {
            "bra.1": "Brasileirão Série A", "bra.2": "Brasileirão Série B", "bra.copa_do_brasil": "Copa do Brasil",
        ...
        async function fetchStandings() {
            ...
            let isCup = lSlug.includes('copa_do_brasil') || lSlug.includes('libertadores') || lSlug.includes('sudamericana') || lSlug.includes('champions') || lSlug.includes('europa') || lSlug.includes('friendly');
